                    ...
                    <div class="c_content">
                        <form action="<?php echo base_url('karyawan/save') ?>" method="post">
                            <div class="form-group">
                                <label>NIP</label>
                                <input type="text" class="form-control input-sm" name="nip" placeholder="Nomor Induk Pegawai (NIP)" autofocus onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                            </div>
                            <div class="form-group">
                                <label>Nama</label>
                                <input type="text" class="form-control input-sm" name="nama" placeholder="Nama Lengkap" required onkeypress="return (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 95 && event.charCode <= 122)">
                            </div>
                            <div class="form-group">
                                <label>Jabatan</label>
                                <input type="text" class="form-control input-sm" name="jabatan" placeholder="Jabatan Pegawai" list="daftarjabatan" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-sm" name="golongan" placeholder="Golongan Pegawai" list="daftargolongan">
