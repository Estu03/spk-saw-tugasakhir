                            ...
                            <tbody>
                                <?php foreach ($data as $d) {?>
                                    <tr>
                                        ...
                                        <td align="center"><button type="button" class="btn btn-warning btn-xs" onclick="window.location.href='<?php echo base_url('kriteria/detail/'.$d['kodekriteria']) ?>'">Detail</button></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
