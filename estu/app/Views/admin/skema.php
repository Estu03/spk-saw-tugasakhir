            ...
            <section class="wrapper">
                <div class="top-page-header">
                    <div class="page-title">
                        <h2>Data Skema</h2>
                        <small>Pengolahan data skema, pilih periode tertentu untuk menampilkan detail skema</small>. <code><strong>PENTING!</strong> total nilai Bobot <strong>HARUS 100%</strong>, tidak boleh lebih atau kurang</code>
                    </div>
                ...
                <div class="c_panel">
                    <div class="c_content">
                        <form class="form-horizontal" action="<?php echo base_url('skema/show') ?>" method="post">
                            <div class="form-group">
                                <label class="col-sm-2 control-label" style="text-align: left;"><strong>Periode Tahun</strong></label>
                                <div class="col-sm-10">
                            ...
                            <tbody>
                                ...
                                for ($i=1; $i <= count($bulan) ; $i++) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo substr($kriteria, 0, strlen($kriteria)-2)."   ";?>|
                                            <?php if($bobot != 100){ ?>
                                                <code><strong><?php echo number_format($bobot)." %"; ?></strong></code>
                                            <?php }else{ ?>
                                                <code style="color:green;"><strong><?php echo number_format($bobot)." %"; ?></strong></code>
                                            <?php } ?>|
                                        </td>
                                        <td align="center"><button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#detail<?php echo $tahun.$i ?>">Detail</button></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
